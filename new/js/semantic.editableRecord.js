(function($) {
    ...
    var defaultSetting = {
        ...
        //buttons
        saveButton: '<div name="save" class="ui ihotel button">БҮРТГЭХ</div>',
        cancellButton: '<div name="cancel" class="ui button">БУЦАХ</div>',
        newButton: '<div class="ui mini positive button">НЭМЭХ</div>',
    ...
    function appendTableHeadForDeleteButton(editableRecord){
        editableRecord.find('thead tr').append('<th name="action">Устгах</th>')
    }
